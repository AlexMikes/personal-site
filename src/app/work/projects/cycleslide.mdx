...
Wall or ceiling-mounted bike rack with a custom-designed aluminum extrusion track, ball bearing rollers, rotating hook, and infinitely expandable for all the bikes. 
